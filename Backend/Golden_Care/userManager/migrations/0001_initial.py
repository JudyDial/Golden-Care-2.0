    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('emergency_contact', models.ManyToManyField(blank=True, related_name='individuals_with_contact', to='userManager.emergencycontact')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='individual',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='individual_emergency_contacts', to='userManager.individual'),
        ),
    ]
